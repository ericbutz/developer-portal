...
guide: 
    name: migrate-to-v2
    step: '2'
title: Migrate to Dwolla v2 API | Making Requests
description: Understand how to make requests on Dwolla's v2 API, and receive guidance on upgrading your application from Dwolla's legacy v1 API. 
---

# Making requests

Since you are talking to a new API, the components that make up a request such as the base URL, headers, and request payload will vary slightly. Interacting with the Dwolla v2 API is fairly straightforward, and you should be aware of the following items when calling the API:

* The base URL has changed in the Dwolla v2 API from `https://www.dwolla.com/oauth/rest/` to simply `https://api.dwolla.com/`
...
#### Comparison of request and response between v1 and the Dwolla v2 API
...
<nav class="pager-nav">
    <a href="01-api-v2-principles.html">Back: Dwolla v2 API principles</a>
